...
// static void UartRxCallback(bsp_err_sts_t status, void* userContext)
// {
//     const UartRxContext_t* ctx = (const UartRxContext_t*)userContext;

//     if((status == BSP_ERR_STS_OK) && (ctx != NULL) && (ctx->rxBuf != NULL))
//     {
...
// static void UartTxCallback(bsp_err_sts_t status, void* userContext)
// {
//     (void)userContext;
...
//     /* Initialize UART */
//     if(bspUartInit((bspUartHandle_t*)&g_bspUartHandles[BSP_UART_OWNER_GNSS]) != BSP_ERR_STS_OK)
//     {
